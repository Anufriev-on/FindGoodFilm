...
class MainActivityTest {
    ...
    fun allMenuDestinationsShouldWork() {
        ...
        onView(withId(R.id.menu_letter)).perform(click())
        onView(withId(R.id.watch_leter_fragment_root)).check(matches(isDisplayed()))

        onView(withId(R.id.menu_selection)).perform(click())
